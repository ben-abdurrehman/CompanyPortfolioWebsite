...
export default function TechnologySolutions() {
  ...
  return (
    <section id="services" className="font-['SatoshiVariable'] w-full flex flex-col gap-10 py-16 px-4 sm:px-6 lg:px-8 2xl:py-40 z-50 text-center">
      ...
      <div ref={sectionRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 w-[90%] md:w-5/6 lg:w-4xl xl:w-5xl 2xl:w-7xl mx-auto">
        {solutions.map((solution, index) => (
          ...
          >
            <div className="bg-white rounded-[10px] shadow-[0_0_8px_#00000040] p-6 2xl:p-6 flex flex-col items-start text-left transition-transform md:hover:translate-y-[-8px] md:hover:translate-x-[-8px]">
